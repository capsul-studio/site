...
exports.handler = async (event) => {
  ...
  if (event.httpMethod === 'POST') {
    ...
    const data = {
      ...
      mode: 'payment',
      success_url: `${"https://capsulstudio.netlify.app"}/booking-success.html?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `${"https://capsulstudio.netlify.app"}/booking-cancel.html?session_id={CHECKOUT_SESSION_ID}`,
